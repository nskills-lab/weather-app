import { timelineWeatherClient } from '../api/clients/timelineWeather.js'
/**
...
export default class ForecastService {
  static async fetchweekly({ location, date1, date2 } = {}) {
    ...
    const URL =
      timelineWeatherClient.endpoint() +
      `/${locationToSearch}/${dateStart}/${dateEnd}?key=${timelineWeatherClient.key}&IconSet=icons1`
